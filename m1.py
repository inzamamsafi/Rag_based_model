...
# chroma_client = chromadb.Client(Settings(persist_directory=os.path.expanduser("~/chromadb")))
...
# Modified function to index data into separate ChromaDB collections with 5000 character chunks (Correct - No changes needed)
def index_data(data):
    ...
    for i, d in enumerate(data):
        ...
        text_chunks = [d['text'][i:i+2000] for i in range(0, len(d['text']), 2000)] # Chunk size changed to 5000
...
# Modified function to get answer from Gemini API using google.generativeai
